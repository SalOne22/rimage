...
mod tests {
    ...
    fn test_parallel_encode() {
        let images = vec![
            PathBuf::from("images/test1.jpg"),
            PathBuf::from("images/test2.jpg"),
            PathBuf::from("images/test3.jpg"),
            PathBuf::from("images/test4.jpg"),
        ];
        ...
        images.into_par_iter().for_each(|path| {
            ...
            encode_image(&path, &pixels, &output_format, width, height, quality).unwrap();
        });
    }
}
