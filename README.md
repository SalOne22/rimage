...
:warning: WARNING: This documentation works only for latest version of rimage! You can get latest version from releases tab or explicitly with cargo: `cargo install rimage@0.11.0-next.0`
